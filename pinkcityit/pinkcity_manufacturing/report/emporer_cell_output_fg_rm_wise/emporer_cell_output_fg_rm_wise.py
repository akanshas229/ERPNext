...
def get_columns():
	return [
		...
		{"fieldname":"rm_code", "fieldtype":"Float", "label":"RM Code", "width":100},
		{"fieldname":"rm_name", "fieldtype":"Float", "label":"RM Name", "width":100},
		{"fieldname":"category", "fieldtype":"Float", "label":"Category", "width":100},
		{"fieldname":"sub_category", "fieldtype":"Float", "label":"Sub Category", "width":140},
		{"fieldname":"qty", "fieldtype":"Float", "label":"Quantity", "width":140},
		{"fieldname":"weight", "fieldtype":"Float", "label":"Weight", "width":140}
	]
...
def get_data(filters):
	...
	if filters.get("company"):
		...
		if filters.get("company") == "Pinkcity Jewelhouse Private Limited-Unit 2" :
			server = '192.168.5.88'
			company_code = "PJ2"
		conditions += f" Fg.FgCoCd =  '{company_code}'"
	...
	query = f"""SELECT 
					...
					Fgd.FdGrWt gross_wt,
					FgRm.FrRmCd rm_code,
					FgRm.FrRmCtg category,
					FgRm.FrRmSCtg sub_category,
					FgRm.FrRmQty qty,
					FgRm.FrRmWt weight 
				FROM FgRm 
				JOIN Fgd ON Fgd.FdFgIdNo = FgRm.FrFdIdNo 
	...
	return all_row
					...
					# ( SELECT RmMst.RmDesc FROM RmMst ) rm_name
