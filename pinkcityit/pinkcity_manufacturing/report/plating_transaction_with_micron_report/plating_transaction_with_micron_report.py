...
def get_columns():
	return [
		...
		{"fieldname":"block_no", "fieldtype":"Data", "label":"Block No - 1st", "width":140},
		{"fieldname":"micron_reading", "fieldtype":"Data", "label":"Micron Reading - 1st", "width":160},
		{"fieldname":"micron_reading_2", "fieldtype":"Data", "label":"Micron Reading - 2nd", "width":160},
		{"fieldname":"micron_reading_3", "fieldtype":"Data", "label":"Micron Reading - 3rd", "width":160},
		{"fieldname":"micron_reading_4", "fieldtype":"Data", "label":"Micron Reading - 4th", "width":160},
		{"fieldname":"micron_reading_5", "fieldtype":"Data", "label":"Micron Reading - 5th", "width":160},
...
def get_data(filters):
	...
	query = f"""SELECT 
				...
				tpmbd.customer_name,
				tpmbd.block_no ,
				GROUP_CONCAT(ROUND(tpmbd.micron_reading, 2)) micron_reading ,
				GROUP_CONCAT(ROUND(tpmbd.micron_reading_2, 2)) micron_reading_2 ,
				GROUP_CONCAT(ROUND(tpmbd.micron_reading_3, 2)) micron_reading_3 ,
				GROUP_CONCAT(ROUND(tpmbd.micron_reading_4, 2)) micron_reading_4 ,
				GROUP_CONCAT(ROUND(tpmbd.micron_reading_5, 2)) micron_reading_5 ,
